...
ax0.errorbar(Vs,Ir,xerr=dVs,yerr=dIr,fmt='.',label='Ir=Vr/R, measured with a voltmeter')#,'o',label='Ir=Vr/R')
ax0.errorbar(Vs,I_g,xerr=dVs,yerr=dI_g,fmt='.',label='I, shunt resistor connected to ground')
ax0.errorbar(Vs,I_ng,xerr=dVs,yerr=dI_ng,fmt='.',label='I, measured with an ammeter')
